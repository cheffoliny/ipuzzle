...
//				: $nYear . "07";
        ...
        $sQuery = "
				...
				FROM {$db_name_sod}.schedule_month_norms sch_mon_nor
				LEFT JOIN {$db_name_personnel}.person_month_limits per_mon_lim	ON ( per_mon_lim.month = sch_mon_nor.month AND per_mon_lim.id_person = {$nIDPerson} )
				WHERE
