    ...
    public function getDocRowsViewByMonth($nID) {
        ...
        $sQuery = "
            SELECT
                ...
                measure,
                `month`,
                IF (`type` = 'month' OR `type` = 'single', SUM(total_sum), SUM(single_price) ) AS single_price,
                IF (`type` = 'month' OR `type` = 'single', SUM(total_sum_bgn), SUM(single_price_bgn) ) AS single_price_bgn,
    ...
    public function getDocRowsViewByService($nID) {
        ...
        $sQuery = "
            SELECT
                ...
                IF (`type` = 'month', SUM(total_sum_bgn), IF (`type` = 'single', SUM(total_sum_bgn), SUM(single_price_bgn) ) ) AS single_price_bgn,
                IF (`type` = 'month', 1, quantity ) as quantity,
                SUM(total_sum) AS total_sum,
                SUM(paid_sum) AS paid_sum,
                SUM(total_sum_bgn) AS total_sum_bgn,
