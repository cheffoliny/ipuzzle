...
Ajax.Request.prototype = jQuery.extend(new Ajax.Base(),{
...
Ajax.Updater.prototype = jQuery.extend(new Ajax.Base(),{
...
Form.Element.Observer.prototype = jQuery.extend(new Abstract.TimedObserver(),{
  getValue: function() {
...
Form.Observer.prototype = jQuery.extend(new Abstract.TimedObserver(),{
  getValue: function() {
...
Insertion.Before.prototype = jQuery.extend(new Abstract.Insertion('beforeBegin'),{
...
Insertion.Top.prototype = jQuery.extend(new Abstract.Insertion('afterBegin'),{
  initializeRange: function() {
...
Insertion.Bottom.prototype = jQuery.extend(new Abstract.Insertion('beforeEnd'),{
  initializeRange: function() {
    this.range.selectNodeContents(this.element);
...
Insertion.After.prototype = jQuery.extend(new Abstract.Insertion('afterEnd'),{
  initializeRange: function() {
