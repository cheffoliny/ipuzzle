...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        if (hasOptions) {
            ...
            if(options.showRanges !== undefined) {
        ...
        if (!hasOptions || (typeof options.startDate == 'undefined' && typeof options.endDate == 'undefined')) {
            if ($(this.element).is('input[type=text]')) {
                ...
                var start1, end1;
                if (split.length == 2) {
                    start1 = moment(split[0], this.format);
                    end1 = moment(split[1], this.format);
                }
    ...
    DateRangePicker.prototype = {
        ...
        //pgk
        resetDates: function() {
            this.oldStartDate = this.oldEndDate = this.startDate = this.endDate = moment().startOf('day');
            this.element.val("");
        ...
        updateCalendars: function () {
            ...
            if (customRange && this.showRanges)
