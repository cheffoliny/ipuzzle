...
{
	idbase      : "dl_calendar_",
	months      : "Яну,Фев,Март,Апр,Май,Юни,Юли,Авг,Септ,Окт,Ноем,Дек",
	days        : "Н,П,В,С,Ч,П,С",
	firstday    : "П",
	...
	tool_tip    : "Натиснете за избор от календар",
	navbar_style : "",
	daybar_style : "",
...
[
[ "#dlcalendar_container",         'width:160px; table-layout:fixed;' ],
[ '#dlcalendar_navigationRow',     'height:1.2em; width:100%; margin:0px; border:1px solid #000000; background-color:#163374; color:#ffffff; font-family:arial,helvetica,sans-serif; text-align:center;  cursor:default;' ],
...
[ '#dlcalendar_headerRow',         'height:1em; text-align:center; vertical-align:middle; color:#ffffff; background-color:#d1d8dc; font-family:arial,helvetica,sans-serif; cursor:default;' ],
...
[ 'td.dlcalendar_dayRegular',      'font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #ffffff; color:#000000; background-color:#ffffff; cursor:pointer' ],
[ 'td.dlcalendar_dayWeekend',      'font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #ffffff; color:#990000; background-color:#ffffff; cursor:pointer' ],
[ 'td.dlcalendar_daySelected',     'font-family:arial,helvetica,sans-serif; font-size:.8em; width:1em; padding:2px; border:1px solid #000000; color:#000000; background-color:#ffffff; cursor:default' ],
...
function dlcalendar_start(isInit)
{
...
function dlcalendar_mToBoolean(obj) {
	...
	if( bWindows )
	{
		...
		if( bDOM )
		{
			...
			if( bCompatible )
			{
				...
				window.dlcalendar_bChrome  = bChrome;
...
function dlcalendar_buildCalendar( oParams )
{
	...
	this.use_webdings = dlcalendar_mToBoolean( this.use_webdings);
...
function dlcalendar_position( e )
{
	...
	var nTopPos  = ( oEvent.pageY || oEvent.y + nWindowTopEdge ); //this.do_top
	nTopPos -= parseInt(this.do_top);
...
function dlcalendar_onNewSelection( nDayOfMonth )
{
	...
	if( dlcalendar_mToBoolean(this.hide_onselection) )
	{
		this.mHide();
	}
	else
