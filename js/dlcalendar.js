...
var dlcalendar_aCalendarStyles =
    [
        ...
        [ 'td.dlcalendar_navWebdings',     'padding: 3px 3px; cursor: pointer;' ],
        [ 'td.dlcalendar_navImages',       'padding: 3px 3px; cursor: pointer; font-size: 13px;' ],
        ...
        [ 'td.dlcalendar_dayRegular',      'padding: 3px 3px; border: 0px solid #ffffff; color:#555555; cursor:pointer' ],
        [ 'td.dlcalendar_dayWeekend',      'padding: 3px 3px; border: 0px solid #ffffff; background-color: #ffefee; color: #f4543c; cursor:pointer;' ],
        [ 'td.dlcalendar_daySelected',     'padding: 3px 3px; border: 0px solid #000000; background-color: #367fa9; color: #ffffff; cursor:default' ],
        [ 'td.dlcalendar_dayOtherMonth',   'padding: 3px 3px; border: 0px solid #ffffff; color:#ffffff; background-color:#ffffff; cursor:default' ],
        [ 'td.dlcalendar_dayDisabled',     'padding: 3px 3px; border: 0px solid #ffffff; color:#cccccc; background-color:#ffffff; cursor:default' ]
    ];
...
function dlcalendar_navigate( e, sCalendarId, bMonth, bNext )
{
    ...
    var dNewDate = new Date(dDisplayedDate.getFullYear(), dDisplayedDate.getMonth(), 1);
    if( bMonth )
    {
