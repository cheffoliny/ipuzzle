...
var calendars = Array();
var fc_months = Array('Ян', 'Фев', 'Март', 'Апр', 'Май', 'Юни', 'Юли', 'Авг', 'Сеп', 'Окт', 'Ноем', 'Дек');
var fc_openCal;
...
function HideControl (tagName, subMenu)
{
...
function fc_show() {
    ...
    if( ( parseInt( this.div.style.top ) + 200 ) > parseInt( document.body.clientHeight ) )
        this.div.style.top = parseInt( this.div.style.top ) - ( ( parseInt( this.div.style.top ) + 200 ) - parseInt( document.body.clientHeight ));

    this.div.style.display = 'block';
    this.shown = true;
    fc_openCal = this;

    if(fc_ie) HideControl ("SELECT", this.div);
}

function fc_generateHTML() {
    var html = '<TABLE><TR><TD CLASS="fc_head" COLSPAN="6">КАЛЕНДАР:</TD><TD CLASS="fc_date" onMouseover="this.className = \'fc_dateHover\';" onMouseout="this.className=\'fc_date\';" onClick="getCalendar(\'' + this.id + '\').hide();"><B>X</B></TD></TR>';
    html += '<TR><TD CLASS="fc_date" title="Предходна година" onMouseover="this.className = \'fc_dateHover\';" onMouseout="this.className=\'fc_date\';" onClick="getCalendar(\'' + this.id + '\').moveMonth(-12);"><B>&laquo;</B></TD><TD CLASS="fc_date" title="Предходен месец" onMouseover="this.className = \'fc_dateHover\';" onMouseout="this.className=\'fc_date\';" onClick="getCalendar(\'' + this.id + '\').moveMonth(-1);"><B>&lsaquo;</B></TD><TD COLSPAN="3" CLASS="fc_wk">' + fc_months[this.showDate.getMonth()] + ' ' + fc_getYear(this.showDate) + '</TD><TD CLASS="fc_date" title="Следващ месец" onMouseover="this.className = \'fc_dateHover\';" onMouseout="this.className=\'fc_date\';" onClick="getCalendar(\'' + this.id + '\').moveMonth(1);"><B>&rsaquo;</B></TD><TD CLASS="fc_date" title="Следваща година" onMouseover="this.className = \'fc_dateHover\';" onMouseout="this.className=\'fc_date\';" onClick="getCalendar(\'' + this.id + '\').moveMonth(12);"><B>&raquo;</B></TD></TR>';
    html += '<TR><TD WIDTH="14%" CLASS="fc_wk">П</TD><TD WIDTH="14%" CLASS="fc_wk">В</TD><TD WIDTH="14%" CLASS="fc_wk">С</TD><TD WIDTH="14%" CLASS="fc_wk">Ч</TD><TD WIDTH="14%" CLASS="fc_wk">П</TD><TD class="fc_wknd" WIDTH="14%">С</TD><TD class="fc_wknd" WIDTH="14%">Н</TD></TR>';
    html += '<TR>';
    var dow = 0;
    var i, style;
