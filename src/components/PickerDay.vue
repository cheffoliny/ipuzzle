  ...
  <div :class="[calendarClass, 'vdp-datepicker__calendar']" v-show="showDayView" :style="calendarStyle" @mousedown.prevent>
    ...
    <header>
      ...
      <span class="day__month_btn" @click="showMonthCalendar" :class="allowedToShowView('month') ? 'up' : ''">
        {{ isYmd ? currYearName : currMonthName }} {{ isYmd ? currMonthName : currYearName }} <i class="fas fa-caret-down fa-fw"></i>
      </span>
      <span
    ...
    <div :class="isRtl ? 'flex-rtl' : 'vdp-datepicker__main'">
...
export default {
  ...
  computed: {
     ...
     */
    currMonthName () {
      return this.fullMonthName ? this.utils.getMonthName(this.pageDate) : this.utils.getMonthNameAbbr(this.pageDate)
    },
    /**
