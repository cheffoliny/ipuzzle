...
if(!empty($text2display)){
	...
	$table->setText(8,0,'<img src="image.php?code='.$filename.'&o='.$output.'&t='.$thickness.'&r='.$res.'&text='.urlencode($text2display).'&f1='.$font_family.'&f2='.$font_size.'&a1='.$a1.'&a2='.$a2.'" alt="Barcode Image" />');
}
?>