   ...
   * If $sql == false, then we purge all files in the cache.
	...
	* then we can scale to 12.8 million unique cached recordsets. Wow!
	 ...
	 * "Jonathan Younger" <jyounger@unilab.com>
  	 */
	function GetUpdateSQL($rs, $arrFields,$forceUpdate=false,$magicq=false,$force=null) // pavel function GetUpdateSQL(&$rs, $arrFields,$forceUpdate=false,$magicq=false,$force=null)
	{
		global $ADODB_INCLUDED_LIB;
	 ...
	 *	   that is run against a single table.
  	 */
	function GetInsertSQL($rs, $arrFields,$magicq=false,$force=null) // pavel function GetInsertSQL(&$rs, $arrFields,$magicq=false,$force=null)
	{	
		global $ADODB_INCLUDED_LIB;
		if (!isset($force)) {
			global $ADODB_FORCE_TYPE;
