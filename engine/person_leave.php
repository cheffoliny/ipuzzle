...
$new_leave				= false; // Право за създаване на нова отпуска

if (!empty($_SESSION['userdata']['access_right_levels'] )) {
	if ( in_array('person_leave_edit', $_SESSION['userdata']['access_right_levels']) ) {
		$personnel_view = true;
		$personnel_edit = true;
	}

	if ( in_array('person_leave_new', $_SESSION['userdata']['access_right_levels']) ) {
		$new_leave = true;
	}
...
$template->assign("new_leave", 		$new_leave);
