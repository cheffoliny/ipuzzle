...
$checks = array(
    strpos($xmlrpc, 'var rpc_xsl = "xsl/general_result.xsl"') !== false,
    strpos($renderer, 'general_result\\.xsl') !== false,
    ...
    strpos($pppTemplate, 'class="w-100 h-100 p-0 m-0"') !== false,
    strpos($mainTemplate, 'src="page.php?page=object_store_ppp" style=') !== false,
