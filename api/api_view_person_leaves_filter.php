<?php
	class ApiViewPersonLeavesFilter
	{
		// remote method
		public function init( DBResponse $oResponse )
		{
			...
			else
			{
				...
				$aData['code_leave_name'] 		= "1";
				$aData['created_user'] 			= "1";
				$aData['status'] 				= "1";
				$aData['time_confirm'] 			= "1";
				$aData['res_leave_from'] 		= "1";
				$aData['res_leave_to'] 			= "1";
				$aData['res_application_days'] 	= "1";
				$aData['person_confirm'] 		= "1";
				//End Default Fields
			}
		...
		public function save( DBResponse $oResponse )
		{
			...
			$aFilterData['report_class'] 	= "ViewPersonLeaves";
