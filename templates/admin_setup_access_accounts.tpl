...
<form action="" name="form1" id="form1" class="ui-access-list" onSubmit="return false;">
	...
	<table class="page_data ui-access-heading">
		<tr>
			...
			<td class="buttons"> 
				{if $right_edit}<button onclick="setupAccount(0);"><span class="ui-icon ui-icon-plus" aria-hidden="true"></span> Добави </button>
				{else}&nbsp;
				{/if}
			</td>
		</tr>
