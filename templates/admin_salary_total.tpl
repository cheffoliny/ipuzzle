...
<form name="form1" id="form1" onSubmit="getResult();return false;">
    ...
    <div>
        <div class="row justify-content-start pl-3 pb-1 pt-2 table-secondary">
            ...
            <div class="col">
                ...
                <div class="btn-group btn-group-sm btn-group-toggle" data-toggle="buttons">
                    <label class="btn btn-compact btn-light mr-1" title="Фирми" onClick="onClickRadioFirms();">
                        <input type="radio" id="type" name="types" value="rFirms" checked="checked" />
                        <i class="fas fa-tag fa-lg text-primary pt-1 pr-1"></i>
                    </label>
                    <label class="btn btn-compact btn-light mr-1" title="Региони" onClick="onClickRadioRegions();" >
                        <input type="radio" id="type" name="types" value="rRegions" />
                        <i class="fas fa-tags fa-lg text-primary pt-1 pr-1"></i>
                    </label>
                    <label class="btn btn-compact btn-light mr-2" title="Обекти" onClick="onClickRadioObjects();">
        ...
        <div id="filters" class="row justify-content-start pl-3 pt-1 pb-2 table-secondary">
            ...
            <div id="filters_center" class="col-4">
                ...
                <div id="pObjects">
                    <div class="input-group input-group-sm">
                        ...
                        <select class="form-control" name="account_objects[]" id="account_objects" style="height: 87px !important;" ondblclick="removeObject()" multiple></>
                    </div>
                </div>
