...
<div class="content">
	<form action="" method="POST" name="form1" onsubmit="my_action = 'save'; return loadXMLDoc( 'save', 2 );">
		...
		<div class="page_caption">{if $id}Приемо предавателен протокол{/if}</div>
		...
		<table class="input">
			...
			<tr class="odd">
				...
				<td>
					<select id="leave_types" name="leave_types" style="width: 100px;" >
						<option value="due">полагаем</option>
						<option value="unpaid">неплатен</option>
						<option value="student">студентски</option>
