...
<form id="form1">
			...
			<td>
				...
				<table class="input">
					<tr class="even">
						...
						<td>
							<select name="sDocType" id="sDocType" style="width:160px;">
								...
								<option vlaue="3">опростена фактура</option>
								<option value="4">кредитно известие</option>
								<option value="5">дебитно известие</option>
								<option value="6">ДДС</option>
								<option value="7">заплати</option>
							</select>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<select id="paid_type" name="paid_type" style="width:100px;">
								<option value="0">Всички</option>
					...
					<tr class="even">
						...
						<td colspan="3">
							<input type="checkbox" class="clear" id="for_fuel" name="for_fuel"> Гориво
							<input type="checkbox" class="clear" id="for_gsm"  name="for_gsm"> GSM
						</td>
					</tr>
				</table>
				</fieldset>
	...
	<table class="input" style="margin-top:10px;">
		<tr>
			<td>
				<fieldset>
				<legend>Доставчки / Клиент</legend>
				<table class="input">
					<tr class="even">
						<td>
							Клиент:
						...
						<td>
							<select id="client_name" name="client_name" style="width:150px;"></select>
						</td>
						<td colspan="4">
							&nbsp;
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" id="deliverer_name" name="deliverer_name" class="inp150" />
						</td>
						<td>
							ЕИН на доставчик:
						</td>
						<td>
							<input type="text" id="deliverer_ein" name="deliverer_ein" class="inp150" />
						</td>
						<td>
							ЕИК на доставчик:
						</td>
						<td>
							<input type="text" id="deliverer_eik" name="deliverer_eik" onkeypress="return formatNumber(event);" class="inp150" />
						</td>
					</tr>
				</table>
				</fieldset>
		...
		<tr>
			<td valign="top">
				...
				<table class="input">
					...
					<tr class="odd" height="22px">
						<td align="right">
							<input type="checkbox" class="clear" name="show_rows_notes" id="show_rows_notes">
						</td>
						<td>
							Редове-Бележки
						</td>
