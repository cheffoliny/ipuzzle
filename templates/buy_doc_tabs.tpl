		...
		<tr>
			...
			{else}
				<td id="inactive" style="width:150px;" nowrap="nowrap">
					<a href="#" onclick="return tab_href('buy_doc_info');" id="buy_doc_info">Информация</a>
				</td>
			{/if}
			...
			{else}
				<td id="inactive" style="width:150px;" nowrap="nowrap">
					<a href="#" onclick="return tab_href('buy_doc_orders');" id="buy_doc_orders">Ордери</a>
				</td>
			{/if}
			<td width="1" id="passive"></td>
			...
			{else}
				<td id="inactive" style="width:150px;" nowrap="nowrap">
					<a href="#" onclick="return tab_href('buy_doc_inventory');" id="buy_doc_inventory">Опис</a>
				</td>
			{/if}
