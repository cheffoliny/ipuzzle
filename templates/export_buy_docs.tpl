        ...
        <tr>
            <td>
                <div class="input-group input-group-sm ui-export-docs-filter">
                    ...
                    &nbsp;
                    <button type="button" class="btn btn-sm btn-primary" onClick="formSubmit();" title="Приложи шаблона"><span class="ui-icon ui-icon-file-export" aria-hidden="true"></span> Експорт </button>
				</div>
			</td>
		</tr>
	</table>
