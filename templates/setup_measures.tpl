...
{literal}
	...
	{
		dialogSetSetupMeasure( 'id=' + id, id );
	}
...
<form action="" name="form1" id="form1" class="ui-nomenclature-list" onSubmit="return false;">
	...
	<table class = "page_data ui-nomenclature-heading">
		<tr>
			<td class="page_name">Мерни единици</td>
			<td class="buttons">
				{if $right_edit}<button onclick="openMeasure( 0 );"><span class="ui-icon ui-icon-plus" aria-hidden="true"></span> Добави </button>
				{else}&nbsp;
				{/if}
			</td>
		</tr>
