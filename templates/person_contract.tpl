...
<form name="form1" id="form1" class="ui-person-detail ui-person-contract-detail" onsubmit="return false;">
		...
		<div class="col-4 pl-3">
			<div class="input-group input-group-sm mb-1">
				...
				<div class="input-group-prepend" id="sFixSalary">
					<span class="ui-icon ui-icon-money" aria-hidden="true" title="Фиксирана заплата"></span>
				</div>
			...
			<div class="input-group input-group-sm mb-1">
				...
				<div class="input-group-prepend" id="sMinSalary">
					<span class="ui-icon ui-icon-money" aria-hidden="true" title="Основна по ТД"></span>
				</div>
			...
			<div class="input-group input-group-sm mb-1 pl-5">
				<div class="input-group-prepend" id="sInsurance">
					<span class="ui-icon ui-icon-minus" aria-hidden="true" title="Мин. осигурителен праг"></span>
				</div>
		...
		<div class="col-4 pl-3">
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend" id="sFactor" >
					<span class="ui-icon ui-icon-calendar" aria-hidden="true" title="Фактор за техници..."></span>
				</div>
			...
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend" id="sShiftsFactor">
					<span class="ui-icon ui-icon-calendar" aria-hidden="true" title="Фактор за смени..."></span>
				</div>
			...
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend">
					<span class="ui-icon ui-icon-clock" aria-hidden="true" title="Прослужено време..."></span>
				</div>
	...
	<div class="row px-2">
		<div class="col-4 pl-3">
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend" id="img_trial_from">
					<span class="ui-icon ui-icon-calendar" aria-hidden="true" title="Oт дата..."></span>
				</div>
		...
		<div class="col-4 pl-3">
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend" id="img_trial_to">
					<span class="ui-icon ui-icon-calendar" aria-hidden="true" title="До дата..."></span>
				</div>
		...
		<div class="col-4">
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend">
					<span class="ui-icon ui-icon-percent" aria-hidden="true" title="Процент базово възнаграждение..."></span>
				</div>
	...
	<div class="row clearfix px-2">
		<div class="col-4">
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend">
					<span class="ui-icon ui-icon-document" aria-hidden="true" title="Образование..."></span>
				</div>
				<input class="form-control" type="text" name="sEducation" id="sEducation" title="Образование" placeholder="Образование..." />
			</div>
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend">
					<span class="ui-icon ui-icon-document" aria-hidden="true" title="Специалност..."></span>
				</div>
				<input class="form-control" type="text" name="sSpeciality" id="sSpeciality"  title="Специалност.." placeholder="Специалност.." />
			</div>
			<div class="input-group input-group-sm mb-1">
				<div class="input-group-prepend">
					<span class="ui-icon ui-icon-document" aria-hidden="true" title="Друга специалност..."></span>
				</div>
		...
		<div class="col-4">
			<div class="input-group input-group-sm">
				<div class="input-group-prepend">
					<span class="ui-icon ui-icon-percent" aria-hidden="true" title="Клас..."></span>
				</div>
	...
	<nav class="navbar fixed-bottom ui-person-detail-actions" id="search" aria-label="Действия по договора">
